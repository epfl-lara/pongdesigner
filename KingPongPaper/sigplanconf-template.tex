...
\title{Behavior-driven graphical programming on Tablets}
\subtitle{Laboratory of Automated Reasoning and Analysis, \\
   EPFL, Lausanne, Switzerland}

\authorinfo{Mikaël Mayer}
           {LARA - EPFL}
           {mikael.mayer@epfl.ch}
\authorinfo{Viktor Kuncak}
           {LARA - EPFL}
           {viktor.kuncak@epfl.ch}
\maketitle

\begin{abstract}
% TODO : Rewrite abstract to make it more appealing.
...
Special thanks to:
Christine Mayer
Philippe Suter, for his feedback.
...
\bibitem[BCG{\etalchar{+}}10]{bodik_programming_2010}
Rastislav Bodik, Satish Chandra, Joel Galenson, Doug Kimelman, Nicholas Tung,
  Shaon Barman, and Casey Rodarmor.
\newblock Programming with angelic nondeterminism.
\newblock {\em {SIGPLAN} Not.}, 45(1):339–352, January 2010.

\bibitem[BEW{\etalchar{+}}98]{bishop_designing_1998}
L.~Bishop, D.~Eberly, T.~Whitted, M.~Finch, and M.~Shantz.
\newblock Designing a {PC} game engine.
\newblock {\em {IEEE} Computer Graphics and Applications}, 18(1):46 --53,
  February 1998.

\bibitem[Bre12]{bret_learnable_2012}
Victor Bret.
\newblock Learnable programming.
\newblock {http://worrydream.com/LearnableProgramming/}, September 2012.

\bibitem[CGL12]{cheema_quickdraw:_2012}
Salman Cheema, Sumit Gulwani, and Joseph {LaViola}.
\newblock {QuickDraw:} improving drawing experience for geometric diagrams.
\newblock In {\em Proceedings of the {SIGCHI} Conference on Human Factors in
  Computing Systems}, {CHI} '12, page 1037–1064, New York, {NY}, {USA}, 2012.
  {ACM}.

\bibitem[Ell01]{elliott_genuinely_2001}
Conal Elliott.
\newblock Genuinely functional user interfaces.
\newblock In {\em In Proceedings of the 2001 Haskell Workshop}, page 41–69,
  2001.

\bibitem[GKP11]{gvero_interactive_2011}
Tihomir Gvero, Viktor Kuncak, and Ruzica Piskac.
\newblock Interactive synthesis of code snippets.
\newblock Technical report, {EPFL}, {SwissFederal} Institute of Technology
  Lausanne, 2011.

\bibitem[Gul12]{gulwani_synthesis_2012}
Sumit Gulwani.
\newblock Synthesis from examples.
\newblock In {\em {WAMBSE} (Workshop on Advances in Model-Based Software
  Engineering) Special Issue, Infosys Labs Briefings}, volume 10(2), 2012.

\bibitem[KKBC12]{kuznetsov_efficient_2012}
Volodymyr Kuznetsov, Johannes Kinder, Stefan Bucur, and George Candea.
\newblock Efficient state merging in symbolic execution.
\newblock {\em {SIGPLAN} Not.}, 47(6):193–204, June 2012.

\bibitem[KKS12]{koksal_constraints_2012}
Ali~Sinan Köksal, Viktor Kuncak, and Philippe Suter.
\newblock Constraints as control.
\newblock In {\em Proceedings of the 39th annual {ACM} {SIGPLAN-SIGACT}
  symposium on Principles of programming languages}, {POPL} '12, page
  151–164, New York, {NY}, {USA}, 2012. {ACM}.

\bibitem[KM08]{ko_debugging_2008}
...
\newblock In {\em Proceedings of the 30th international conference on Software
  engineering}, {ICSE} '08, page 301–310, New York, {NY}, {USA}, 2008. {ACM}.

\bibitem[KMPS10]{kuncak_comfusy:_2010}
Viktor Kuncak, Mikael Mayer, Ruzica Piskac, and Philippe Suter.
\newblock Comfusy: A tool for complete functional synthesis (tool
  presentation).
\newblock In T.~Touili, B.~Cook, and P.~Jackson, editors, {\em Computer Aided
  Verification, Proceedings}, volume 6174, pages 430--433. Springer-Verlag
  Berlin, Berlin, 2010.

\bibitem[LDW03]{lau_learning_2003}
Tessa Lau, Pedro Domingos, and Daniel~S. Weld.
\newblock Learning programs from traces using version space algebra.
\newblock In {\em Proceedings of the 2nd international conference on Knowledge
  capture}, K-{CAP} '03, page 36–43, New York, {NY}, {USA}, 2003. {ACM}.

\bibitem[OMM{\etalchar{+}}04]{odersky_overview_2004}
Martin Odersky, Stéphane Micheloud, Nikolay Mihaylov, Michel Schinz, Erik
  Stenman, Matthias Zenger, and et~al.
\newblock An overview of the scala programming language.
\newblock Technical report, 2004.

\bibitem[Sal12]{sal_khan_2012}
Shantanu Sal.
\newblock Khan academy.
\newblock http://www.khanacademy.org, 2012.

\bibitem[SCC06]{simonyi_intentional_2006}
Charles Simonyi, Magnus Christerson, and Shane Clifford.
\newblock Intentional software.
\newblock {\em {SIGPLAN} Not.}, 41(10):451–464, October 2006.

\bibitem[SG12]{singh_synthesizing_2012}
Rishabh Singh and Sumit Gulwani.
\newblock Synthesizing number transformations from input-output examples.
\newblock In {\em Proceedings of the 24th international conference on Computer
  Aided Verification}, {CAV'12}, page 634–651, Berlin, Heidelberg, 2012.
  Springer-Verlag.

\bibitem[SRJ08]{sanchez-ruiz_funfonts:_2008}
Arturo~J. Sánchez-Ruíz and Lisa~A. Jamba.
\newblock {FunFonts:} introducing 4$^{\textrm{th}}$ and 5$^{\textrm{th}}$
  graders to programming using squeak.
\newblock In {\em Proceedings of the 46th Annual Southeast Regional Conference
  on {XX}}, {ACM-SE} 46, page 24–29, New York, {NY}, {USA}, 2008. {ACM}.

\bibitem[SVY09]{shacham_chameleon:_2009}
Ohad Shacham, Martin Vechev, and Eran Yahav.
\newblock Chameleon: adaptive selection of collections.
\newblock {\em {SIGPLAN} Not.}, 44(6):408–418, June 2009.

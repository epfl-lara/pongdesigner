...
//        
	...
	public void addStickyActionItem(ActionItem action) {
	  action.setSticky(true);
	...
	public boolean forceNextTop = false;
	public boolean forceNextBottom = false;
	public boolean forceNextLeft = false;
...
/*
	public void show (MenuButton anchor, View parent) {
	  ...
	  Rect inputRect= anchor.rectData();
  ...
  public void show(Rect anchorRect, View parent) {
    ...
    preShow();
    mDidAction      = false;
		//Rect anchorRect 	= new Rect(anchor.left, anchor.top, anchor.left + anchor.width(), anchor.top 
		//                	+ anchor.height());
		...
		if(forceNextTop) onTop = true;
		if(forceNextBottom) onTop = false;

		if (onTop) {
			if (rootHeight > dyTop) {
				yPos 			= 15;
				LayoutParams l 	= mScroller.getLayoutParams();
				l.height		= dyTop - anchorRect.height();
			} else {

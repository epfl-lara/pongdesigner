...
class PongBrickBreaker3Players extends Game {
  ...
  WhenEver(ball6.y - ball6.radius > screenHeight || ball6.y + ball6.radius < 0 || ball6.x - ball6.radius > screenWidth || ball6.x + ball6.radius < 0) {
    if(ball6.y - ball6.radius > screenHeight || ball6.y + ball6.radius < 0 || ball6.x - ball6.radius > screenWidth || ball6.x + ball6.radius < 0) {
      ball6.x = 344 // 1 more
      ball6.y = 397 // 1 more
    }
  }.represents(EApply(ESelect(EApply(ESelect(EApply(ESelect(EApply(ESelect(EApply(ESelect(ESelect(EIdentShape(ball6), "y"), "$minus"),List(ESelect(EIdentShape(ball6), "radius"))), "$greater"),List(EIdent("screenHeight"))), "$bar$bar"),List(EApply(ESelect(EApply(ESelect(ESelect(EIdentShape(ball6), "y"), "$plus"),List(ESelect(EIdentShape(ball6), "radius"))), "$less"),List(EConstantNumber(0.0))))), "$bar$bar"),List(EApply(ESelect(EApply(ESelect(ESelect(EIdentShape(ball6), "x"), "$minus"),List(ESelect(EIdentShape(ball6), "radius"))), "$greater"),List(EIdent("screenWidth"))))), "$bar$bar"),List(EApply(ESelect(EApply(ESelect(ESelect(EIdentShape(ball6), "x"), "$plus"),List(ESelect(EIdentShape(ball6), "radius"))), "$less"),List(EConstantNumber(0.0))))),List(IfCode(EApply(ESelect(EApply(ESelect(EApply(ESelect(EApply(ESelect(EApply(ESelect(ESelect(EIdentShape(ball6), "y"), "$minus"),List(ESelect(EIdentShape(ball6), "radius"))), "$greater"),List(EIdent("screenHeight"))), "$bar$bar"),List(EApply(ESelect(EApply(ESelect(ESelect(EIdentShape(ball6), "y"), "$plus"),List(ESelect(EIdentShape(ball6), "radius"))), "$less"),List(EConstantNumber(0.0))))), "$bar$bar"),List(EApply(ESelect(EApply(ESelect(ESelect(EIdentShape(ball6), "x"), "$minus"),List(ESelect(EIdentShape(ball6), "radius"))), "$greater"),List(EIdent("screenWidth"))))), "$bar$bar"),List(EApply(ESelect(EApply(ESelect(ESelect(EIdentShape(ball6), "x"), "$plus"),List(ESelect(EIdentShape(ball6), "radius"))), "$less"),List(EConstantNumber(0.0))))),List(ParallelExpressions(List(EApply(ESelect(ESelect(EIdentShape(ball6), "x"), "$eq"),List(EConstantNumber(344.0))), EApply(ESelect(ESelect(EIdentShape(ball6), "x"), "$plus$eq"),List(EConstantNumber(-162.0))))), ParallelExpressions(List(EApply(ESelect(ESelect(EIdentShape(ball6), "y"), "$eq"),List(EConstantNumber(397.0))), EApply(ESelect(ESelect(EIdentShape(ball6), "y"), "$plus$eq"),List(EConstantNumber(-73.0)))))),List())))
  WhenEver(ball1.y - ball1.radius > screenHeight || ball1.y + ball1.radius < 0 || ball1.x - ball1.radius > screenWidth || ball1.x + ball1.radius < 0) {
    if(ball1.y - ball1.radius > screenHeight || ball1.y + ball1.radius < 0 || ball1.x - ball1.radius > screenWidth || ball1.x + ball1.radius < 0) {
      ball1.x = 129 // 1 more
      ball1.y = 595 // 1 more
    }
  }.represents(EApply(ESelect(EApply(ESelect(EApply(ESelect(EApply(ESelect(EApply(ESelect(ESelect(EIdentShape(ball1), "y"), "$minus"),List(ESelect(EIdentShape(ball1), "radius"))), "$greater"),List(EIdent("screenHeight"))), "$bar$bar"),List(EApply(ESelect(EApply(ESelect(ESelect(EIdentShape(ball1), "y"), "$plus"),List(ESelect(EIdentShape(ball1), "radius"))), "$less"),List(EConstantNumber(0.0))))), "$bar$bar"),List(EApply(ESelect(EApply(ESelect(ESelect(EIdentShape(ball1), "x"), "$minus"),List(ESelect(EIdentShape(ball1), "radius"))), "$greater"),List(EIdent("screenWidth"))))), "$bar$bar"),List(EApply(ESelect(EApply(ESelect(ESelect(EIdentShape(ball1), "x"), "$plus"),List(ESelect(EIdentShape(ball1), "radius"))), "$less"),List(EConstantNumber(0.0))))),List(IfCode(EApply(ESelect(EApply(ESelect(EApply(ESelect(EApply(ESelect(EApply(ESelect(ESelect(EIdentShape(ball1), "y"), "$minus"),List(ESelect(EIdentShape(ball1), "radius"))), "$greater"),List(EIdent("screenHeight"))), "$bar$bar"),List(EApply(ESelect(EApply(ESelect(ESelect(EIdentShape(ball1), "y"), "$plus"),List(ESelect(EIdentShape(ball1), "radius"))), "$less"),List(EConstantNumber(0.0))))), "$bar$bar"),List(EApply(ESelect(EApply(ESelect(ESelect(EIdentShape(ball1), "x"), "$minus"),List(ESelect(EIdentShape(ball1), "radius"))), "$greater"),List(EIdent("screenWidth"))))), "$bar$bar"),List(EApply(ESelect(EApply(ESelect(ESelect(EIdentShape(ball1), "x"), "$plus"),List(ESelect(EIdentShape(ball1), "radius"))), "$less"),List(EConstantNumber(0.0))))),List(ParallelExpressions(List(EApply(ESelect(ESelect(EIdentShape(ball1), "x"), "$eq"),List(EConstantNumber(129.0))), EApply(ESelect(ESelect(EIdentShape(ball1), "x"), "$plus$eq"),List(EConstantNumber(-376.0))))), ParallelExpressions(List(EApply(ESelect(ESelect(EIdentShape(ball1), "y"), "$eq"),List(EConstantNumber(595.0))), EApply(ESelect(ESelect(EIdentShape(ball1), "y"), "$plus$eq"),List(EConstantNumber(75.0)))))),List())))
  WhenEver(ball1.y - ball1.radius > screenHeight || ball1.y + ball1.radius < 0 || ball1.x - ball1.radius > screenWidth || ball1.x + ball1.radius < 0) {
    if(ball1.y - ball1.radius > screenHeight || ball1.y + ball1.radius < 0 || ball1.x - ball1.radius > screenWidth || ball1.x + ball1.radius < 0) {
      ball1.x = 129 // 1 more
      ball1.y = 595 // 1 more

...
class Tutorial extends Game {
  ...
  val house = Category("House elements")()
  val characters = Category("Characters")()
  
  val rudy = character(characters)(name="Rudy", x=0, y=0, width=1, height=2)
  
  val speech = """Hi ! My name is Rudy.
    I recently forgot to .
  ...
  val soundtts = soundTTS(cat2)(name="soundtts",x= -10.5f, y=7f, time= 1, language="en", text="Welcome to Pong Designer, made by Lara at E P F L !")
  
  val soundtts2 = soundTTS(cat2)(name="soundtts2",x= -10.5f, y=6f, time= 150, language="fr", text="Bienvenue à Pongue Dizaïneur réalisé par Lara, à l'eupéheffelle !")
